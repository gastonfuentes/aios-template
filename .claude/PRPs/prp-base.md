...
> Template PRP adaptado al flujo Praxis.
...
|---------|-----------|-------------|
| **Origen** | De donde viene este PRP (un brief, o planificacion directa) | Agente al generar |
...
| **Plan de implementacion** | Fases ordenadas (sin subtareas todavia) | Agente propone |
...
2. Agente: lee brief origen si existe, hereda Directiva/Supuestos/Fuera de Alcance/Aprendizajes
3. Agente: investiga contexto, viabilidad, codigo a reutilizar
4. Agente: genera PRP-XXX-nombre.md usando este template
...
8. Agente: al cerrar, propaga aprendizajes al brief origen (si existe)
```
...
> Voz: impersonal. Aprendizajes transversales de `CLAUDE.md` que apliquen a este trabajo, o de una corrida previa parcial del mismo brief.
...
[Aprendizaje 2 de Fase Y — fecha de cierre — aplicar en: ...]
...
- **Validacion**:
  ...
  - [ ] [comandos derivados del tipo de proyecto del brief origen — default Praxis cuando no hay brief: `npx tsc --noEmit`, `npm run build`, `npm test`, Playwright]
